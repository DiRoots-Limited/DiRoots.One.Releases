...
![View Manager manage views](../../../assets\images\ViewManager\SG-Vm-ViewType.gif)
...
![View Manager add parameters columns](../../../assets\images\ViewManager\SG-Vm-Parameters.gif)
...
![View Manager manage views](../../../assets\images\ViewManager\SG-Vm-OpenView.gif)
...
![View Manager duplicate view](../../../assets\images\ViewManager\SG-Vm-DuplicateManually.gif)
...
![View Manager delete view](../../../assets\images\ViewManager\SG-Vm-DeleteManually.gif)
...
![View Manager duplicate view](../../../assets\images\ViewManager\SG-Vm-DuplicateBatch.gif)
...
![View Manager delete view](../../../assets\images\ViewManager\SG-Vm-DeleteBatch.gif)
...
![View Manager export excel file from views](../../../assets\images\ViewManager\SG-Vm-Export.gif)

<sub>Note: the version on the image may not reflect the [latest version of ViewManager/DiRootsOne](https://diroots.com/revit-plugins/dirootsone/).</sub>

2. Import exel file to update the views list.

![View Manager import excel file](../../../assets\images\ViewManager\SG-Vm-Import.gif)
...
![View Manager rename views](../../../assets\images\ViewManager\SG-Vm-Rename.gif)
...
![View Manager build name](../../../assets\images\ViewManager\SG-Vm-BuildName.gif)
...
![View Manager new set](../../../assets\images\ViewManager\SG-Vm-SaveSet.gif)
...
![View Manager apply filter](../../../assets\images\ViewManager\SG-Vm-FilterSet.gif)
...
![View Manager clear all](../../../assets\images\ViewManager\SG-Vm-Clear.gif)
